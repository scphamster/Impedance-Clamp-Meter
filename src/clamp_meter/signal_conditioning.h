...
//static uint8_t clamp_sensor_gain_preset[CLAMP_SENSOR_MAX_OVERALL_GAIN + 1] = { 0, 0, 1, 2, 3, 4, 4, 4, 4, 4 };
//
//static gain_type_t clamp_sensor_adc_gain_preset[CLAMP_SENSOR_MAX_OVERALL_GAIN + 1] = { GAIN_1V3, GAIN_1, GAIN_1, GAIN_1,
//                                                                                       GAIN_1,   GAIN_1, GAIN_2, GAIN_4,
//                                                                                       GAIN_8,   GAIN_16 };
//
//static uint8_t shunt_sensor_gain_preset[SHUNT_SENSOR_MAX_OVERALL_GAIN + 1] = { 0, 0, 1, 2, 3, 4, 4, 4, 4, 4 };
//
//static gain_type_t shunt_sensor_adc_gain_preset[SHUNT_SENSOR_MAX_OVERALL_GAIN + 1] = { GAIN_1V3, GAIN_1, GAIN_1, GAIN_1,
//                                                                                       GAIN_1,   GAIN_1, GAIN_2, GAIN_4,
//                                                                                       GAIN_8,   GAIN_16 };

static float32_t adc_gain_coeffs[6] = { (1.f) / (3.f), 1, 2, 4, 8, 16 };
